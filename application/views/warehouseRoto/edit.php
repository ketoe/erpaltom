<h3>Edycja - <?php echo $sap; ?></h3>

<form action="/WarehouseRoto/save" method="POST">
	...
	<div class="form-group"><label for="code">Oznaczenie:</label>
		<input type="text" name="sap" value="<?php echo $sap; ?>" class="form-control" />
	</div>

	<div class="form-group"><label for="value">Paczkowanie:</label>
		<input type="text" name="pack" value="<?php echo $pack; ?>" class="form-control" />
	</div>
